  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (values.dataAgendamento && tecnicoValue) {
        ...
        // Se a data for removida, volta para engenharia.
        // Se já estava em outro status (digitacao, medicina, etc) mantém o status
        if (['agendado', 'aguardando_visita', 'engenharia'].includes(service.status)) {
